...
It may take a while to map the data, but please map 10 million reads from `SRR5331338` before February 23rd.  Here are the commands I used:
...
zcat ${atfRaw}SRR5331338_ATF1_ChIP.fastq.gz | head -44000000 |tail -40000000 > ${atfFq}ATF1_chip_10m_260218.fastq

#load bowtie2 module and run 
module load bowtie2

bowtie2 -p2 -t -x $hgGen -U ${atfFq}ATF1_chip_10m_260218.fastq -S ${atfSam}ATF1_10m_align_260218.sam 2>&1 | tee ${atfSam}ATF1_chip_10m_260218_alignment_log.txt
...
bowtie -p4 -v2 -m1 $hg_bt ${atfFq}ATF1_chip_10m_260218.fastq  -S ${atfSam}ATF1_10m_bt1_align_260218.sam 2>&1 | tee ${atfSam}ATF1_chip_10m_260218_alignment_bt1_log.txt
