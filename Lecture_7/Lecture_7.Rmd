...
```{r engine='bash', eval=F, echo=TRUE}
unzip /Users/guertinlab/Downloads/bowtie2-2.5.4-macos-arm64.zip
cd /Users/guertinlab/Downloads/bowtie2-2.5.4-macos-arm64
```
...
/Users/guertinlab/Downloads/bowtie2-2.5.4-macos-arm64.zip


```{r engine='bash', eval=F, echo=TRUE}
/Users/guertinlab/Downloads/bowtie2-2.5.4-macos-arm64/bowtie2 -h 
```
...
export PATH=$PATH:/Users/guertinlab/Downloads/bowtie2-2.5.4-macos-arm64
...
**3.** View duplicate sequences (`fastx_collapser`) \
...
If you are running Ubuntu on a Windows OS, then the following command should work to open an HTML file.
