...
Recall that the HTML files on GitHub are difficult to access with a user interface? Well you can right click on *Download* to copy the link address to the file and `wget` the file directly.

```{r engine='bash', eval=F, echo=TRUE}
wget https://github.com/guertinlab/meds5420/raw/main/Lecture2_command_line/230123_Lec02_Shell.html
```
...
Since this answer is a dynamic process of logging into Xanadu, making a bunch of files with command line text editors, you can just watch me stumble through the process and learn from my mistakes by watching the video starting at 1:08:50: http://guertinlab.cam.uchc.edu/meds5420_2023/230208_Lec7_recording.mp4 
