...
**Map 10 million reads from each file to the genome with `bowtie2` (this should be completed already):** \
...
A `bedGraph1 file that computes coverage for only the 5' end of the read.\
