---
title: \sf MEDS5420 - Lecture 20 - R Functions and plotting
header-includes:
- \usepackage{color}
- \usepackage{float}
...
46) **Quick R** is also one of many good resources for plotting: [http://www.statmethods.net/](http://www.statmethods.net/)
...
```{r, eval=T, echo=F}
#read in table
closest <- read.table("/Users/guertinlab/MEDS5420/peaks_promoters.bed")
