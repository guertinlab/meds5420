...
* Indentify (de novo) enriched motifs with a set of sequences.\
...
* There are more options avaiable.  See manual or [http://meme-suite.org/doc/meme.html?man_type=web](http://meme-suite.org/doc/meme.html?man_type=web).\
